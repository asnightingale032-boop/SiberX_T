...
Security, for real below — plus a dedicated
...
impact) lives in `docs/` — start there if you want
...
COOP/CORP — all set in `vercel.json`.
...
`SECURITY.md` and `/.wellknown/security.txt`
